        ...
        {isProvider && user.providerProfile && (
          <Card className="p-6 shadow-lg border-slate-200/60 bg-white/80 backdrop-blur-sm hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="space-y-4">
              {/* Restaurant Name */}
              <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-slate-50/50 transition-colors duration-200">
                <div className="p-2 bg-linear-to-br from-purple-50 to-purple-100 rounded-lg">
              ...
              {/* Address */}
              <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-slate-50/50 transition-colors duration-200">
                <div className="p-2 bg-linear-to-br from-rose-50 to-rose-100 rounded-lg">
              ...
              {user.providerProfile.description && (
                <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-slate-50/50 transition-colors duration-200">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-slate-900 font-medium wrap-break-word leading-relaxed">
                      {user.providerProfile.description}
                    </p>
                  </div>
                </div>
              ...
              {user.providerProfile.logo && (
                <div className="pt-4 mt-4 border-t border-slate-100">
                  ...
                  <div className="relative inline-block">
                    <img
                      src={user.providerProfile.logo}
                      alt={user.providerProfile.name}
                      className="h-32 w-auto object-contain rounded-xl bg-linear-to-br from-slate-50 to-slate-100 p-4 shadow-md hover:shadow-lg transition-shadow duration-300"
                    />
                  </div>
                </div>
              )}
